...
export const TicketDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="ticketsManagementApp.ticket.delete.question">
        <Translate contentKey="ticketsManagementApp.ticket.delete.question" interpolate={{ id: ticketEntity.id }}>
