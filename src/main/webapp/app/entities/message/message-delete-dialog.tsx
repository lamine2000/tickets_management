...
export const MessageDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="ticketsManagementApp.message.delete.question">
        <Translate contentKey="ticketsManagementApp.message.delete.question" interpolate={{ id: messageEntity.id }}>
