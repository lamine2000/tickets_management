...
/**
 * Criteria class for the {@link sn.trivial.ticket.domain.Client} entity. This class is used
 * in {@link sn.trivial.ticket.web.rest.ClientResource} to receive all the possible filtering options from
...
public class ClientCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, firstName, lastName, email, userId, distinct);
    }
