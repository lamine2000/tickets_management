...
class MessageResourceIT {
    ...
    @Test
    @Transactional
    void getAllMessagesByTicketIsEqualToSomething() throws Exception {
        Ticket ticket;
        ...
        // Get all the messageList where ticket equals to ticketId
        defaultMessageShouldBeFound("ticketId.equals=" + ticketId);

        // Get all the messageList where ticket equals to (ticketId + 1)
